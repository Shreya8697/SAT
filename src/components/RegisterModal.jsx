...
const RegisterModal = ({ isRegisterOpen, setIsRegisterOpen, registerForm, setRegisterForm, handleRegister }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-2 sm:p-4">
      <div className="bg-white/10 backdrop-blur-md rounded-xl p-4 sm:p-6 md:p-8 w-full max-w-xs sm:max-w-sm md:max-w-md border border-white/20 mx-2 sm:mx-4">
        {/* Modal Header */}
        ...
        {registrationSuccess ? (
          <div className="space-y-4 sm:space-y-6">
            <div className="text-center py-2 sm:py-4">
              <p className="text-green-400 text-base sm:text-lg mb-3 sm:mb-4">
              ...
              <p className="text-gray-300 mt-3 sm:mt-4 text-sm sm:text-base animate-pulse">
          ...
          <div className="space-y-3 sm:space-y-4 md:space-y-6">
            {/* Error Message */}
            {error && (
              <div className="bg-red-500/20 border border-red-500 text-red-200 px-3 py-2 sm:px-4 sm:py-3 rounded-lg text-sm sm:text-base">
                {error}
              </div>
            )}
            ...
            <div>
              ...
              <input
                type="text"
                className="w-full px-3 py-2 sm:px-4 sm:py-3 text-sm sm:text-base bg-white/10 border border-white/20 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500"
